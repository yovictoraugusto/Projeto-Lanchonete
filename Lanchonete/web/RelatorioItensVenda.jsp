...
<%
  ...
  ResultSet rs = rel.relatorioItensVenda();
                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/victo/OneDrive/Documentos/ESTUDOS/III/JAVA/TRABALHO/Completo/Lanchonete/Lanchonete/web/relatorio/relatorioItensVenda.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há Itens de Venda cadastrado, para cadastrar um Itens de Venda clique no menu CADASTRO > Venda." />
</jsp:forward>
