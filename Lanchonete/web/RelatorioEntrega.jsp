...
<%
  ...
  ResultSet rs = rel.relatorioEntrega();
                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/victo/OneDrive/Documentos/ESTUDOS/III/JAVA/TRABALHO/Completo/Lanchonete/Lanchonete/web/relatorio/relatorioEntrega.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há entrega cadastrado, para cadastrar um entrega clique no menu CADASTRO > Entrega." />
</jsp:forward>
