...
<%
  ...
  ResultSet rs = rel.relatorioUnidade();
                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/victo/OneDrive/Documentos/ESTUDOS/III/JAVA/TRABALHO/Completo/Lanchonete/Lanchonete/web/relatorio/relatorioUnidade.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há unidade cadastrada, para cadastrar uma unidade clique no menu CADASTRO > Unidade." />
</jsp:forward>
