...
<%
  ...
  ResultSet rs = rel.relatorioVendas2();
                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/victo/OneDrive/Documentos/ESTUDOS/III/JAVA/TRABALHO/Completo/Lanchonete/Lanchonete/web/relatorio/relatorioVendas2.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há vendas cadastradas, para cadastrar vendas clique no menu CADASTRO > Vendas2." />
</jsp:forward>
