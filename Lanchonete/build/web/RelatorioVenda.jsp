...
String caminho = "C:/Users/victo/OneDrive/Documentos/ESTUDOS/III/JAVA/TRABALHO/Completo/Lanchonete/Lanchonete/web/relatorio/relatorioVenda.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há vendas cadastradas, para cadastrar vendas clique no menu CADASTRO > Venda." />
</jsp:forward>
