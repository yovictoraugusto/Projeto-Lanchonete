...
<%
  ...
  ResultSet rs = rel.relatorioFuncao();
                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/victo/OneDrive/Documentos/ESTUDOS/III/JAVA/TRABALHO/Completo/Lanchonete/Lanchonete/web/relatorio/relatorioFuncao.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há função cadastrado, para cadastrar um função clique no menu CADASTRO > Função." />
</jsp:forward>
